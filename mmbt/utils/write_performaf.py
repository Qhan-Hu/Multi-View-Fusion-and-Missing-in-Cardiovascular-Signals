...
print(os.getcwd())
split = 'test'
load_path = r'F:\09_proj_multi_modality\multi-modality-biosignal\datasets\PERFormAF\PERFormAF_' + split + '.h5'
...
with pa.OSFile(f"{save_path}/PERFormAF_{split}.arrow", "wb") as sink:
